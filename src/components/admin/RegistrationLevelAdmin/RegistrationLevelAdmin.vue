      ...
      <div class="business-region">
        ...
        <div class="table-region">
          <el-table :data="this.showedRegistrationLevels" style="width: 100%">
            ...
            <el-table-column label="挂号级别ID" prop="id" width="60"> </el-table-column>
            <el-table-column label="挂号级别编码" prop="code"> </el-table-column>
            <el-table-column label="挂号级别名称" prop="name"> </el-table-column>
            <el-table-column label="挂号费" prop="cost"> </el-table-column>
            <el-table-column label="挂号限额" prop="quota"> </el-table-column>
...
export default {
  ...
  methods: {
    ...
    search() {
      registrationlevel
        .getRegistrationLevelById(this.input)
        .then((response) => {
    ...
    handleDelete(index, row) {
      registrationlevel
        .deleteRegistrationLevel(row.id)
        .then((response) => {
    ...
    setShowedRegistrationLevels() {
      ...
      this.showedRegistrationLevels = this.registrationlevels.slice(
