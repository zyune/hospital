<template lang="html">
  <div class="container">
    ...
    <el-dialog :visible.sync="addUserDialogVisible" width="60%" :before-close="handleClose">
      <user-info-editor>添加用户</user-info-editor>
    </el-dialog>
    <el-dialog :visible.sync="editUserDialogVisible" width="60%" :before-close="handleClose">
...
import UserBasicInfo from '@/components/common/UserBasicInfo.vue';
